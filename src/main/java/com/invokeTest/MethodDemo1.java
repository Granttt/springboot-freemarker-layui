 ...
 * @Author: gaoxi
 * @CreateDate: 2019/4/18 22:33
 * @UpdateUser: gxy
 * @UpdateDate: 2019/4/18 22:33
 * @UpdateRemark: 通过获取类的类型，进而获取Method对象，进而调用类的方法，
 * 和直接通过类的对象来调用方法可以达到一样的效果，这里的示例调用了对象的三个方法
 * https://www.cnblogs.com/wjf0/p/8098123.html
 * @Version: 1.0
 */
public class MethodDemo1 {
    public static void main(String[] args) {
        ...
        A a1 = new A();
        Class c = a1.getClass();
        // 2.获取方法 名称和参数列表来决定 getMethod获取的是public的方法 getDelcaredMethod获取自己声明的方法
        try {
